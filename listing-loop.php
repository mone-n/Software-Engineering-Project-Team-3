						...
						<ul class="lp-post-quick-links">
							<li>
								<a href="#" data-post-type="grids" data-post-id="<?php echo esc_attr(get_the_ID()); ?>" data-success-text="<?php echo esc_html__('Saved', 'listingpro') ?>" class="status-btn <?php if ($favrt == 'yes') {
									...
									<i class="fa <?php echo esc_attr($isfavouriteicon); ?>"></i> <span><?php echo wp_kses_post($isfavouritetext); ?></span>
								</a>
							</li>
							<li>
						...
						if (!empty($cats)) {
							...
							foreach ($cats as $cat) {
								if ($catCount == 1) {
									...
									if (!empty($category_image)) {
										$term_link = get_term_link($cat);
										echo '<div class="lp-category-icon-outer"><a href="' . $term_link . '"><span class="cat-icon"><img class="icon icons8-Food" alt="image"src="' . $category_image . '" alt="cat-icon"></span></a></div>';
									}
								...
								if (!empty($cats)) {
									...
									foreach ($cats as $cat) {
										if ($catCount == 1) {
											$category_image = listing_get_tax_meta($cat->term_id, 'category', 'image');
											if (!empty($category_image)) {
												echo '<span class="cat-icon"><img class="icon icons8-Food" alt="image" src="' . $category_image . '" alt="cat-icon"></span>';
											}
											$term_link = get_term_link($cat);
											echo '
																<a href="' . $term_link . '">
